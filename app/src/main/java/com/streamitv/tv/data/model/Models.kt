package com.streamitv.tv.data.model

/**
 * Domänenmodelle der App.
 *
 * Diese Klassen sind bewusst frei von Netzwerk- und Datenbank-Details:
 * - Die Xtream-JSON-Antworten (siehe [com.streamitv.tv.data.remote.xtream.XtreamDto])
 *   werden per Mapper hierher übersetzt.
 * - Die Room-Entities (siehe [com.streamitv.tv.data.local.Entities]) spiegeln sie 1:1.
 *
