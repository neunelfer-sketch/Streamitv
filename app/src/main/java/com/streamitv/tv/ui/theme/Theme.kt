package com.streamitv.tv.ui.theme
...
private val StreamiTvColorScheme = darkColorScheme(
    primary = TvAccent,
...
val StreamiTvTypography = Typography(
...
fun StreamiTvTheme(
    ...
    MaterialTheme(
        colorScheme = StreamiTvColorScheme,
        typography = StreamiTvTypography,
    ) {
