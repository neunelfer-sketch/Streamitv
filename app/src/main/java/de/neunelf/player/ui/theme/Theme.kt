package de.neunelf.player.ui.theme
...
private val NeunelfPlayerColorScheme = darkColorScheme(
    primary = TvAccent,
...
val NeunelfPlayerTypography = Typography(
 ...
 */
@Composable
fun NeunelfPlayerTheme(
    content: @Composable () -> Unit,
) {
    MaterialTheme(
        colorScheme = NeunelfPlayerColorScheme,
        typography = NeunelfPlayerTypography,
    ) {
