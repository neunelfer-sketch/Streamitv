package de.xott.player.ui.theme
...
private val XottPlayerColorScheme = darkColorScheme(
    primary = TvAccent,
...
val XottPlayerTypography = Typography(
...
fun XottPlayerTheme(
    ...
    MaterialTheme(
        colorScheme = XottPlayerColorScheme,
        typography = XottPlayerTypography,
    ) {
