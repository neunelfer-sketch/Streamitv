package de.xott.player.ui.login
...
import de.xott.player.ui.components.DeveloperCredit
import de.xott.player.ui.theme.TvAccent
import de.xott.player.ui.theme.TvBackground
import de.xott.player.ui.theme.TvOnSurface
    ...
    Box(
        ...
        Surface(
            ...
            Column(
                ...
                Text("xOTT Player einrichten", style = MaterialTheme.typography.headlineLarge)
