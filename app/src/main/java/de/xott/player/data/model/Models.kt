package de.xott.player.data.model

/**
 * Domänenmodelle der App.
 *
 * Diese Klassen sind bewusst frei von Netzwerk- und Datenbank-Details:
 * - Die Xtream-JSON-Antworten (siehe [de.xott.player.data.remote.xtream.XtreamDto])
 *   werden per Mapper hierher übersetzt.
 * - Die Room-Entities (siehe [de.xott.player.data.local.Entities]) spiegeln sie 1:1.
 *
