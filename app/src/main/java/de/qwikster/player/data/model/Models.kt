package de.qwikster.player.data.model
 ...
 * - Die Xtream-JSON-Antworten (siehe [de.qwikster.player.data.remote.xtream.XtreamDto])
 *   werden per Mapper hierher übersetzt.
 * - Die Room-Entities (siehe [de.qwikster.player.data.local.Entities]) spiegeln sie 1:1.
 *
