...
-keep,includedescriptorclasses class de.xott.player.data.remote.**$$serializer { *; }
-keepclassmembers class de.xott.player.data.remote.** {
    *** Companion;
}
-keepclasseswithmembers class de.xott.player.data.remote.** {
    kotlinx.serialization.KSerializer serializer(...);
}
